...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'P3Talk.sub_community'
        db.delete_column(u'p3_p3talk', 'sub_community')


    def backwards(self, orm):
        # Adding field 'P3Talk.sub_community'
        db.add_column(u'p3_p3talk', 'sub_community',
    ...
    models = {
        ...
        u'conference.talk': {
            ...
            'track': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '20'}),
