...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TicketConference.food_intolerance'
        db.add_column(u'p3_ticketconference', 'food_intolerance',
                      self.gf('django.db.models.fields.TextField')(default='', null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TicketConference.food_intolerance'
        db.delete_column(u'p3_ticketconference', 'food_intolerance')
    ...
    models = {
        ...
        u'p3.ticketconference': {
            ...
            'food_intolerance': ('django.db.models.fields.TextField', [], {'default': "''", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
